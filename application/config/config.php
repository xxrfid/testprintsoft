...
$config['base_title'] = 'Printsoft';
$config['base_description'] = 'Management Order & Research';
$config['base_icon'] = '1627201105432.png'; //upload/logo
$config['google_tag_manager'] = '[]';
$config['base_author'] = 'Achmad Rifai';
$config['base_generator'] = 'CodeIgniter,jQuery,AdminLTE';

$config['urlassets'] = 'https://orijawazone.b-cdn.net';
$config['urluploadurl'] = 'https://linkstorage.b-cdn.net';
$config['channelsoket'] = 'orijawadotid';
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
